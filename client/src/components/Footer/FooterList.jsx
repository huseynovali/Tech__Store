...
function FooterList() {
  return (
    <div className="py-[45px]">
      <div className="back__data flex justify-between">
        ...
        <div className="address text-white w-[290px] text-sm">
          ...
          <p>Phones: <a href="tel:+" className="text-[#01A4FF]">(00) 1234 5678</a> </p>
          <p>We are open: Monday-Thursday: 9:00 AM - 5:30 PM</p>
          <p>Friday: 9:00 AM - 6:00 PM</p>
          <p>Saturday: 11:00 AM - 5:00 PM</p>
          <p>E-mail: <a href="mailto:" className="text-[#01A4FF]"> shop@email.com</a></p>
        </div>
      </div>
    </div>
  );
