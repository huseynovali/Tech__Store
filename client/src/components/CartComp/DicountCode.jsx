...
function DicountCode() {
  return (
    <div>
        <label htmlFor="" className='text-sm font-semibold pb-2 block'>Enter discount code</label>
        <input type="text" name="" id=""  className="w-full p-3 border border-[#A2A6B0] rounded" placeholder='Enter discount code'/>
